      ...
      <SafeAreaView style={styles.main_conteiner}>
        <ScrollView>
          ...
          <View style={styles.data}>
            ...
            <View style={styles.viget1}>
              <Text style={styles.bigTextWiget}>Liczba zachorowań dzisiaj</Text>
              <View
                style={{
                  flexDirection: "row",
              ...
              >
                ...
                <Text style={styles.dataText}>
                  {"   " + this.state.newstate[0].Bilanszachorowań}
                </Text>
              </View>
            </View>

            <View style={styles.viget2}>
              <Text style={styles.bigTextWiget}>Liczba zgonów dzisiaj</Text>
              <View
                style={{
                  flexDirection: "row",
                  justifyContent: "center",
              ...
              >
                ...
                <Text style={styles.dataText2}>
                  {"   " + this.state.newstate[1].Bilanszgonów}
                </Text>
              </View>
            </View>

            <View style={styles.viget1}>
              <Text style={styles.bigTextWiget}>Ilość chorych łącznie</Text>
              <View
                style={{
                  flexDirection: "row",
                  justifyContent: "center",
              ...
              >
                ...
                />
                <Text style={styles.dataText}>
                  {"   " + this.state.newstate[3].Liczba}
                </Text>
              </View>
            </View>

            <View style={styles.viget2}>
              <Text style={styles.bigTextWiget}>Ilość zgonów łącznie</Text>
              <View
                style={{
                  flexDirection: "row",
                  justifyContent: "center",
              ...
              >
                ...
                />
                <Text style={styles.dataText2}>
                  {"   " + this.state.newstate[2].Liczbazgonów}
                </Text>
              </View>
            </View>

            <View style={styles.viget1}>
              <Text style={styles.bigTextWiget}>
                Przewidywana liczba zachorowań
              </Text>
              <View
                style={{
                  flexDirection: "row",
              ...
              >
                ...
                />
                <Text style={styles.dataText}>
                  {"   " + this.state.newstate[4].Przewidywanezachorowania}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.viget2}>
              ...
              >
                ...
                />
                <Text style={styles.dataText2}>
                  {"   " + this.state.newstate[5].Przewidywanezgony}
                </Text>
              </View>
            </View>
